...
# ========== 【入力】ここだけ差し替える ==========
TOCHI        = 71_000_000    # 土地価格（資金計画書 20260920）
KENMONO      = 99_900_000    # 建物価格（LINE記載）
JIKO_RITSU   = 0.1587        # 自己資金割合（27,113,000 ÷ 170,900,000 相当）
RATE         = 0.0255        # 借入金利
YEARS        = 35            # 借入期間
HYOMEN       = 0.080         # 満室想定表面利回り（未入手のため仮）
SHOHIYO      = 11_213_000    # 諸経費（資金計画書 20260920。不動産取得税150万円を含む）
...
TOCHI_SENKO_M= 12            # 土地先行融資の月数（2027/2/26〜2028/2/29）
# ===============================================
